...
def _validate_and_sanitize_plan(
    ...
    for i, tool_call in enumerate(plan.tool_calls, 1):
        ...
        if is_action_tool:
            ...
            logger.info(f"✓ Action tool {tool_name}: skipping parameter validation (Coverage will handle)")
            print(f"   ✓ Action tool {tool_name}: parameters will be generated by Coverage")
